...
Currently the center of boyancy is wrong in the script V3 I am going to try to fix the center of mass and
center of bouancy in the metastatic height calculations. 


ALL THE OLD DATA was only 75mm short the boat wasn't extended 40mm horizontally. 
Now I fixed the CAD Model. 
"""
